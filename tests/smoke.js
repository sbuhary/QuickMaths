...
assert(html.includes("Winding stage path") && html.includes("class=\"level-road\"") && css.includes(".level-road path") && css.includes('.level-node[data-stage="12"] { left: 50%; top: 93%; }') && css.includes("min-height: 1140px"), "Vertical stage path layout missing");
