...
assert(html.includes("Winding stage path") && html.includes("class=\"level-road\"") && css.includes(".level-road path") && css.includes('.level-node[data-stage="12"]'), "Winding stage path layout missing");
